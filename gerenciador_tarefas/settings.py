...
SECRET_KEY = 'django-insecure-b-5mtgp!h3i6fbr^n+*&ltft*vpa=l5)nbb4gq)7%uky!l4+ld'
...
# Sempre criar um app então deve ser definido aqui.
INSTALLED_APPS = [
...
# Realiza as configurações do Heroku
